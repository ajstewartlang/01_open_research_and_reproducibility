...
Welcome to the Open Research and Reproducibility workshop. Like the other workshops in this series, this one will involve a mix of recorded videos, narrative, and links to various resources for you to explore and to read. Here is a brief introduction from myself - you can make the video full screen by clicking on the icon in the bottom right of the image.  

&nbsp;&nbsp;

<center>

<iframe width="560" height="315" src="https://youtube.com/embed/P6KgKnaodJo" frameborder="0" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://youtube.com/embed/g_jD7HmRulg" frameborder="0" allowfullscreen></iframe>

</center>

&nbsp;&nbsp;

If you have a Google account, you can also view and download the slides in a range of formats by clicking on the image below. If you don't have a Google account, you can download the slide in .pdf format by [clicking here](../slides/introduction_to_open_research.pdf).
...
<iframe width="560" height="315" src="https://youtube.com/embed/_4wz7DtaLC8" frameborder="0" allowfullscreen></iframe>

</center>

&nbsp;&nbsp;

If you have a Google account, you can also view and download the slides in a range of formats by clicking on the image below. If you don't have a Google account, you can download the slide in .pdf format by [clicking here](../slides/adopting_open_practices.pdf).
&nbsp;&nbsp;
